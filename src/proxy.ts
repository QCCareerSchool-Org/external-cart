...
export const config = {
  matcher: [
    ...
    '/((?!api|_next/static|_next/image|favicon.ico|images/|makeup/|event/|design/|pet/|wellness/|writing/|ppa/).*)', // also ignore requests to /makeup/, /event/, etc. (they refer to the public directory)
  ],
};
